...
---@param setDirty bool
function m.SetLODSettings(lodBias, maximumLODLevel, setDirty) end
---@param index int
...
function m.GetQualitySettings() end
---@param buildTargetGroupName string
---@param renderPipelineAssets System.Collections.Generic.List<UnityEngine.Rendering.RenderPipelineAsset>
function m.GetAllRenderPipelineAssetsForPlatform(buildTargetGroupName, renderPipelineAssets) end
UnityEngine = {}
