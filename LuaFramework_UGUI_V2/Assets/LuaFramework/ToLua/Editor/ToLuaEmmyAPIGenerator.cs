...
namespace Emmy
{
    ...
    public class ToLuaEmmyAPIGenerator
    {
         ...
         public static void DoIt()
        {
            ...
            string dest = LuaConst.luaAPIDir;
            GlobalEditorHelper.DelFolder(dest);
            var directory = Directory.CreateDirectory(dest);
            ...
            foreach (var bindType in bindTypes)
            {
                ...
                generator.Gen(bindType, dest);
            }
            Debug.LogFormat("API 生成完毕. {0}", dest);
        }
    }
    ...
    abstract class CodeGenerator
    {
        ...
        public virtual void Gen(BindType bt, string dir)
        {
            _bindType = bt;
    ...
    class LuaAPIGenerator : CodeGenerator
    {
        ...
        public override void Gen(BindType bt, string dir)
        {
            ...
            string fileName = string.Format("{0}/{1}Wrap.lua", dir, bt.wrapName);
